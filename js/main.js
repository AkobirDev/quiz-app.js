...
document.querySelector('.qs_count').innerHTML = `<h5>${qs_count} of ${quizData.length} Questions</h5>`
...
btn.addEventListener('click',() =>{
    ...
    else quizContainer.innerHTML = `<p>Your result: <br><h1>${correct}/${quizData.length}</h1><br></p>`
})
